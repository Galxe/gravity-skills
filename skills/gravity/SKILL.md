...
- **Use Multicall3 / Permit2 / CreateX / ERC-4337 / wG** → rollout **in progress**; canonical addresses are known but not all live on mainnet yet — verify on-chain before hardcoding: [`references/preinstalls.md`](references/preinstalls.md)
